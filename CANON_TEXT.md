...
**説明 JA**
Cyberwafer v25の構造と運動を、磨かれた金属と厚みのある光の文字で再構成。ピンクから赤へ移るT、青緑の文字環、循環するクローム円盤。ドラッグで回転、ピンチで拡大、タップで拍動。高精細写真にも切り替えて鑑賞できます。

**説明 EN**
The structure and motion of Cyberwafer v25, recast in polished metal and solid luminous lettering. A pink-to-red T, turquoise text rings and circulating chrome wafers. Drag to orbit, pinch to zoom, tap to pulse. Switch to the high-resolution photograph to view the rendered scene.
...
**断章 JA**
落ちているのは在庫照合の表である。誰も像を注文していない。綴りの一つ一つに描写の意図は無かった。ただ列が満ちたとき、濃度の差が顔になった。技師は最初、汚れを疑った。次に印字の癖を疑った。最後に、疑うべき対象が存在しないことに気づいた。命令は発せられていない。修正は始まっていた。

**断章 EN**
What falls is a stock reconciliation table. No one ordered an image. In none of the individual entries was there any intent to depict. Only when the columns filled did the difference in density become a face. The engineer suspected soiling first, then a habit of the printer, and last of all understood that there was nothing left to suspect. No order had been issued. The correction had begun.
...
- 旧・壁の貫通口一式（キャビネット・ポート・ボルト 66 点）を伏せた。配線が接続盤へ移り、役目が無くなったため
- 操作：8視点の巡回を廃止し、**視点ごとに釦**を置いた（タンク／脳／下部／電源盤／回転台）。ほかに motion のみ。回転も拡大縮小も作品面で自由に行える
...
**断章 JA**
円盤は上から降り、縮み、消える一点で乳滴に変わる。滴は落ち、皮質の頭頂へ当たる。給餌の速度は拍と一致していた。ただし、その拍を発した装置が見つからない。制御室の記録には流量の指示値だけがあり、周期の指示は白紙である。基壇の上の帯は空にされている。据えるものが無かったのではなく、据えないことが図面に指定されていた。

**断章 EN**
The discs descend, contract, and at the point of vanishing become a drop of milk. The drop falls and strikes the crown of the cortex. The feed rate matched the beat. Yet the instrument that issued that beat cannot be found. The control room records hold only the set value for flow; the field for period is blank. The band upon the plinth has been left empty. It was not that there was nothing to be seated there. That nothing be seated there was specified in the drawings.
...
**断章 EN**
Three rings revolve at differing rates, tuned so as to hold no period in common. By calculation there exists no instant at which they coincide. No altar was required. Neither offering, nor a place to kneel, nor any who recite. What was required was a ratio. For this reason the rite does not end. The habit of calling that which does not end a faith had, by this time, fallen out of use.
...
- w2（同日）：光束を、細めの三本が横一列に並ぶ束へ。各本はそれぞれの軸方向へ速く流れる光の粒を運ぶ（0.8〜0.95 周/秒）。視点を替えたときの描画の重さへの対策（解像度の自動調整を 1 秒ごとの判定へ、床・映り込み・金物の計算を軽く）
- w3（同日）：束の三本は横一列に揃わず、束の中でわずかに不規則に揺らぐ（横・縦とも約 ±17 mm）
- w5（同日）：視点を替えた後のコマ送りを解消。原因は描画ループの増殖（操作の釦を押すと、押し込みの動きの間に次の描画の予約が二重に取られ、ループが増え続けていた）。映り込みとガラスの画質は w1 の水準へ戻した
- w6（同日）：素線を太く（芯 半径 18 mm）、揺らぎを大きく（約 ±31 mm）。時間の進みを全体に半分にし、9 本の素線はすべて違う速さ。素線を包む光は明るさ一定（流れる光の粒は芯だけ）。ガラスの肉厚、壁と基壇の艶、床の映り込みの揺らぎ、周辺減光を加えた
- w7（同日）：web の描画を Blender の正本（s8）に合わせて写実を詰めた。同じカメラで明るさを窓ごとに測り、室の照度と環境を s8 から焼き直し、壁と床の石に艶（天井の円環灯と光条の映り込み）を加え、床の映り込みを研磨むらに応じてぼかした。手前のガラスが光条を足しすぎて乳白に曇っていたのを直し、環の穴が澄んで見えるようにした。光条は正本と同じ明るさへ（0.87 倍）
...
**説明 JA**
Empyrean Sigilを立体化した独立Study。二重の輪と目盛りが逆方向に回転し、細環が上昇、鏡面の銀盤が下降する。明暗それぞれに調整した配色で全画面鑑賞できる。ドラッグで回転、ピンチで拡大、タップで心拍を与える。

**説明 EN**
An independent three-dimensional study of Empyrean Sigil. Open circular rails and radial ticks counter-rotate around ascending rings and descending polished silver discs. Full-viewport viewing with distinct dark and light palettes: drag to rotate, pinch to zoom and tap to pulse.
