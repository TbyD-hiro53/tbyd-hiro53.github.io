...
(function(root){
  ...
  var ZOOM_PER_STEP=0.978; /* 遠近スライダは相対操作 */
  ...
  function wireLegacy(){
    var zoom=byId('zoom'),i,b,missing=[];
  ...
  root.LactoCortexUI={
    ...
    report:function(){
      var c=composer();
      return {adapter:'caloris-v2-c2-20260922',mounted:mounted,views:mounted?views().length:0,
