 ...
 * c5（2026-09-23）：毎フレームの書き戻しは、視点か再生状態が変わったときだけ。h53-chrome が 'motion' を 'Pause' に
 *     書き換えるので、毎フレーム書くと翻訳と書き合いになり DOM の変更が毎フレーム起きていた（Sanctum w3 と同じ直し方）。
...
(function(root){
  ...
  root.LactoCortexUI={
    ...
    report:function(){
      var c=composer();
      return {adapter:'cortex-v10-c5-20260923',mounted:mounted,views:mounted?views().length:0,
