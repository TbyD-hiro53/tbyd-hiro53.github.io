/* The Armillary v2（レンズ版）を、公開中の作品と同じ共有UI構成へ接続するアダプタ。v1 w1 の adapter から釦名だけ替えた（make_page_v2.py）。
...
(function(root){
  ...
  root.ArmillaryUI={
    ...
    report:function(){
      var c=composer();
      return {adapter:'armillary-v2-w1',mounted:mounted,views:mounted?views().length:0,
