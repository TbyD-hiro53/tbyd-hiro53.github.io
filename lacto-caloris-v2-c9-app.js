(function () {
'use strict';
var params=new URLSearchParams(location.search),method='B';var GEO_PARTS=(window.__CALORIS_GEO_PARTS||["lacto-caloris-v2-c9-geometry-part0.bin", "lacto-caloris-v2-c9-geometry-part1.bin", "lacto-caloris-v2-c9-geometry-part2.bin", "lacto-caloris-v2-c9-geometry-part3.bin", "lacto-caloris-v2-c9-geometry-part4.bin"]);
...
var meshes=[],moving=[],data,materials={},textures={},ready=false;
...
function medium(m,role){
 ...
 m.customProgramCacheKey=function(){return 'c9-medium-1-'+priorKey;};
}
